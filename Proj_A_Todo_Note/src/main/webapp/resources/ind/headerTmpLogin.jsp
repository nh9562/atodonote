	...
	<header id="header" class="dFrex header">
   		<div class="headerLogo container">
   			<div class="row row-col-auto">
   				<div class="col" style="min-width: 250px;cursor:pointer" id="topLogo">
    			...
    			<div class="col">
					...
					<button id="mainPage" name="mainPage" class="btn btn-purple headerIcon" style="float:right;margin-right:10px;"
